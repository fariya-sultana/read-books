...
const AboutUs = () => {
    return (
        <div className="max-w-6xl mx-auto px-4 py-10 min-h-screen">
            ...
            <p className="text-lg opacity-70 mb-6 text-center max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                ...
                <div className="bg-white p-6 rounded shadow-md">
                    <h2 className="text-black text-2xl font-semibold mb-4">🔐 Easy & Secure Borrowing</h2>
                    <p className="text-gray-700">
                ...
                <div className="bg-white p-6 rounded shadow-md">
                    <h2 className="text-black text-2xl font-semibold mb-4">🚀 Features You’ll Love</h2>
                ...
                <div className="bg-white p-6 rounded shadow-md">
                    <h2 className="text-2xl font-semibold mb-4 text-black">💬 Connect With Us</h2>
                    <p className="text-gray-700">
